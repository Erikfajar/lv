            ...
            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12">
                <div class="card">
                    <div class="card-header pt-4 pb-0">
                        ...
                        <p class="tx-12 text-muted mb-0"> Berikut adalah data semua akun user yang telah di buat <a href="">Learn more</a> </p>
                    </div>
                    <div class="p-4">
                        <div class="">
                            <div class="row">
                    ...
                    <div class="task-stat pb-0">
                        <p style="margin-left: 3em">data terakhir yang input</p>
                        @foreach ($dtTerakhirUser as $item)
                            
                        <div class="d-flex tasks">
                            <div class="mb-0">
                                <div class="h6 fs-15 mb-0"><i class="far fa-dot-circle text-primary me-2"></i>{{ $item->username }}</div>
            ...
            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6">
                <div class="card overflow-hidden">
                    <div class="card-body pd-y-7 pt-3">
                        <div id="grafik_peminjaman_perbulan" style="width:100%"></div>
                    </div>
                </div>
            </div>
        </div>
